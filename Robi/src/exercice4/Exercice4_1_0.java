...
public class Exercice4_1_0 {
	...
	public Exercice4_1_0() {
		...
		///Commandes de robi
		RobiColor commande1 = new RobiColor();
		RobiTranslate commande2 = new RobiTranslate();
		environment.getReferenceByName("robi").addCommand("color", commande1);
		environment.getReferenceByName("robi").addCommand("translate", commande2);
		
		///Commandes de robi
		SpaceColor commande3 = new SpaceColor();
		Sleep commande4 = new Sleep();
		environment.getReferenceByName("space").addCommand("color", commande3);
		environment.getReferenceByName("space").addCommand("sleep", commande4);
	...
	private void run(SNode expr) {
		...
		if(receiver == null) {
			System.out.println("Unkown widget");
		} else {
			receiver.run(expr);
		}
